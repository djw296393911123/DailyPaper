...
public class ThemInfoAdapter extends RecyclerView.Adapter<ThemInfoAdapter.HotHolder> {
    ...
    public void notifyListChange(List<ThemInfoData.StoriesBean> list) {
        this.list.clear();
    ...
    public void onBindViewHolder(HotHolder holder, final int position) {
        ...
        if (images != null) Glide.with(context).load(images.get(0)).asBitmap().into(holder.imageView);
